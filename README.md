...
DevSync ships with an extensive **Playwright E2E suite** (325 tests across 36 spec files) covering authentication & sessions, workspace/project/channel CRUD, sprint lifecycles, task management, and a rigorous RBAC matrix including cross-project isolation. 
