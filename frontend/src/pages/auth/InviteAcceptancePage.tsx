...
export const InviteAcceptancePage = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center font-sans text-foreground p-4">
      <div className="bg-card border border-border rounded-lg p-10 max-w-md w-full text-center shadow-md relative overflow-hidden">
        {/* Decorator */}
        ...
        {status === 'idle' && (
          <div className="py-2">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-2">Workspace Invitation</h2>
            ...
            <div className="space-y-3">
              <Button 
                ...
                variant="default"
                className="w-full py-3 bg-primary hover:bg-primary-hover text-primary-foreground font-bold rounded-lg transition-colors flex items-center justify-center h-auto"
              >
                Accept Invitation
              </Button>
              <Button 
                ...
                variant="ghost"
                className="w-full py-3 bg-transparent hover:bg-hover text-muted-foreground font-medium rounded-lg transition-colors h-auto"
              >
                Decline & Return Home
              </Button>
            </div>
        ...
        {status === 'loading' && (
          <div className="py-6">
            ...
            <h2 className="text-xl font-bold text-foreground mb-2">Accepting Invitation...</h2>
        ...
        {status === 'success' && (
          <div className="py-6">
            ...
            <Button 
              ...
              variant="default"
              className="w-full py-3 bg-primary text-primary-foreground font-bold rounded-lg flex items-center justify-center gap-2 hover:bg-primary-hover transition-colors h-auto"
            >
        ...
        {status === 'error' && (
          <div className="py-6">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-2">Invalid or Expired Invite</h2>
            ...
            <Button 
              onClick={() => navigate('/workspaces')}
              variant="secondary"
              className="w-full py-3 bg-secondary hover:bg-hover text-foreground font-bold rounded-lg transition-colors h-auto"
            >
              Return to Dashboard
            </Button>
          </div>
