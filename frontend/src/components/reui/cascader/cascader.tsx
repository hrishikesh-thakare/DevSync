...
const CHIPS_CLASS =
  "flex flex-wrap items-center border bg-clip-padding focus-within:border-ring has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 has-aria-invalid:border-destructive dark:has-aria-invalid:border-destructive/50 px-2.5 text-sm transition-[color,box-shadow] focus-within:ring-3 has-aria-invalid:ring-3 min-h-8 gap-1 py-1 has-data-[slot=combobox-chip]:px-1 focus-within:ring-ring/30 bg-input/50 border-transparent rounded-2xl duration-200"

const CHIP_CLASS =
  "text-foreground flex w-fit items-center justify-center gap-1 font-medium whitespace-nowrap px-1.5 text-xs h-[calc(--spacing(5.25))] bg-input dark:bg-input/60 rounded-2xl has-data-[slot=combobox-chip-remove]:pr-0.5"

const CHIP_REMOVE_CLASS =
  "opacity-50 hover:opacity-100 -ml-0.5 size-4.5 aria-disabled:pointer-events-none"
...
const CONTENT_SURFACE_CLASS =
  "bg-popover text-popover-foreground data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 overflow-hidden ring-1 duration-100 ring-foreground/5 rounded-2xl dark:ring-foreground/10 shadow-lg data-[side=inline-start]:slide-in-from-right-2 data-[side=inline-end]:slide-in-from-left-2"
